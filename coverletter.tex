...
%  - Programming skills
%    - MATLAB, Python, C
%    - MATLAB and C in class, Python on Github in Resume
%  - Desire to learn new skills
%    - Inventor ==> PolyTwist
%    - LabVIEW?
%  - Ability to work in a team
%    - Participated in many design projects (Mod1, Mod3, 200)
%    - DND Internship, given autonomy on project and accomplished it
